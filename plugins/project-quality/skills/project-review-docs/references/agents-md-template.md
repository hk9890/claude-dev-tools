...
> In this read-only review skill, this template is the conformance standard the auditor checks an existing `AGENTS.md` against — it is not rewritten here.

This structure describes a well-formed `AGENTS.md`. Keep it concise and pointer-based — it is a routing surface, not a handbook.
