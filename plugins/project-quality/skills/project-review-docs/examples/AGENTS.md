...
### Analyze bugs, logs, monitoring

Load [docs/MONITORING.md](docs/MONITORING.md) to analyze logs, spans, or events — use this for bug reproduction, performance analysis, and health checks.
