...
if (typeof agent === 'function') {
  ...
  const workerPrompt = (comp, idx) => {
    ...
    return (
      ...
      `  - the selector stayed GREEN → reached="no". No test executes this line at all. That is UNTESTED CODE, not a weak assertion, and the report must say so — the fix is a new test, never a stronger one. reach_evidence = "selector green with a throw at the site".\n` +
