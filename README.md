...
| Plugin | Description |
|---|---|
| [`tasks`](plugins/tasks/) | Write and file tasks worth executing — `tasks-writing` (the standard a task body follows, printed by the taskmgr store it files into) and `tasks-create` (turns the current conversation into a filed, dependency-ordered set). |
