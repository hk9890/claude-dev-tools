...
| [`project-quality`](plugins/project-quality/README.md) | Project-quality toolkit — read-only adversarial reviews (complexity, structure, tests, consistency, docs, plan/design grilling) and thin, human-triggered exec skills (run tests, cut a release, analyze monitoring, implement per conventions) |
